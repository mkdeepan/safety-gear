...
// TODO : Make the table look better - trim the column content and display full value upon tool tip. Need to work on this
...
$output .= "<div class='woocommerce-MyAccount-content table-container'> <div class='woocommerce-notices-wrapper'></div>
            ...
            if(!empty($results))
            {
                foreach ( $results as $result ) {
                    ...
                    foreach($result as $column => $value){
                        $output .="<td class='woocommerce-orders-table__cell woocommerce-orders-table__cell-order-number'>".$value."</td>";
                    }
