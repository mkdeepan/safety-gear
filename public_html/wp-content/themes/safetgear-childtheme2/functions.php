     ...
     if ($order && $status == "processing") {
         ...
         $order_items = $order->get_items();
            ...
            foreach ($order_items as $item_id => $item) {
                ...
                '".$product_url."','".$customer_name."','".$code."','".$currentDate."','".$plant_code."','D3','Z01','ms01','1000','Z01','ZSPA',".$net_revenue.");";
				echo $query;
